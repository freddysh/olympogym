...
<head>
    ...
    <title>Admin | Olympogym</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.6 -->
    <link href="{{elixir('css/bootstrap/css/bootstrap.min.css')}}" type="text/css" rel="stylesheet" media="screen,projection"/>
    <link href="{{elixir('css/jquery-ui.css')}}" type="text/css" rel="stylesheet" media="screen,projection"/>
    <link href="{{elixir('css/plugins/datatables/dataTables.bootstrap.css')}}" type="text/css" rel="stylesheet" media="screen,projection"/>
    ...
    <!-- jvectormap -->
    <link href="{{elixir('css/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}" type="text/css" rel="stylesheet" media="screen,projection"/>
    {{--<link rel="stylesheet" href="plugins/jvectormap/jquery-jvectormap-1.2.2.css">--}}
    <!-- Theme style -->
    {{--<link rel="stylesheet" href="dist/css/AdminLTE.min.css">--}}
    <link href="{{elixir('css/dist/css/AdminLTE.min.css')}}" type="text/css" rel="stylesheet" media="screen,projection"/>

    <!-- AdminLTE Skins. Choose a skin from the css/skins
             folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="{{elixir('css/dist/css/skins/_all-skins.min.css')}}">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="{{route('admin_path')}}" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini">GYM</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Sistema </b>GYM</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">{{auth()->guard('admin')->user()->name}}, {{auth()->guard('admin')->user()->apellidos}}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                ...
                                <p>
                                    {{auth()->guard('admin')->user()->name}}, {{auth()->guard('admin')->user()->apellidos}}
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="{{route('logout_patch')}}" class="btn btn-default btn-flat">Salir</a>
                                </div>
                            </li>
                        </ul>
                    </li>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>{{auth()->guard('admin')->user()->name}}, {{auth()->guard('admin')->user()->apellidos}}</p>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{route('admin_path')}}"><i class="fa fa-dashboard"></i> Inicio</a></li>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">@yield('miembros')</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Membresias</span>
                            <span class="info-box-number">@yield('membresias')</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
